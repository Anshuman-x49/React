const Cards = ({ users, deleteUser, editUser }) => {
    return (
        <div className="p-4 w-64 border border-gray-400 shadow-md rounded-2xl flex flex-col gap-6 text-white bg-gray-800">
            ...
            <div className="flex justify-between">
                ...
                <button onClick={() => editUser(users.id)} className="bg-blue-700 px-6 py-2 rounded-lg hover:bg-blue-900 transition-all duration-200 cursor-pointer hover:scale-102 uppercase">edit</button>
            </div>
        </div>
    )
}
